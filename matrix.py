"""
| This module implements issue#64 assigned to kruslin2 and passed automated unittest with 100% coverage
| The coverage report in pdf format is attached to the GitHub link pull request associated with issue#64.
| This module declares a class Matris capable of various matrix operations for geometric coordinates
...
def copy_matrix(matrix):
	...
	"""
		This global function performs copy operations on a matrix


		:param name: matrix
		:param type: math.matrix
		:return: math.matrix
		"""

	return copy.deepcopy(matrix) # we need to use deepcopy since we're dealing with 2D arrays

# variable identity_matrix initialization
...
def multiply_matrices(x_matrix, y_matrix):
	...
	"""
		This global function performs matrix multiplications


		:param name: x_matrix, y_matrix
		:param type: math.matrix
		:return: none
		"""
...
# Class matrix for various matrix operations methods
class Matrix:
	...
	def __init__(self, base = None):
        ...
        # Class variable data initialization with identity_matrix 
	def load_identity(self):
		"""
	    This class function loads an identity matrix on class variable data
	...
	def __mul__(self, matrix):
        ...
        # Matrix multiplication with variable data
	...
	def scale(self, x, y, z):
		...
		"""
		This class function performs strecht-out operations on an object in 3D, when users are playing the game.
	...
	def translate(self, x, y, z):
		...
		"""
		This class function performs matrix translation operations

		:param name: left, right, bottom, top, near, far
		:param type: integer
		:return: none
		"""
		for i in range(4):
	...
	# Matrix rotation by angle degree
	def rotate(self, angle, x, y, z):

		"""
		This class function performs rotation operations on an object in 3D, when users are playing the game.


		:param name: angle, x, y, z
		:param type: integer
		:return: none
		"""
	...
	def rotate_2d(self, x, y): 
		...
		"""
		This class function performs rotation operations on an object in 2D, when users are playing the game.
        ...
        # Frustum operation in 3D
	def frustum(self, left, right, bottom, top, near, far):

		"""
		This class function performs frustum operations on an object in 3D, when users are playing the game.
	...
	def perspective(self, fovy, aspect, near, far):
		...
		"""
		This class function helps other modules performing perspective drawings in 2D


		:param name: fovy, aspect, near, far
		:param type: integer
		:return: none
		"""
	...
	def orthographic(self, left, right, bottom, top, near, far):
		"""
		This class function performs  orthographic projection operations on an object in 3D, when users are playing the game.
...
class MyCodeTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.m.load_identity()
        self.l = self.m.__mul__(self.n)	
        self.m.data = self.m.__imul__(self.n)
        self.k.scale(1, 1, 1,)
    ...
    def test_operation(self):
        # Test operations
        self.assertNotEqual(self.m.data, identity_matrix)
        self.assertIsInstance(self.l, object)
        self.assertEqual(self.k.data, self.n.data)
	
        self.k.translate(1, 1, 1)   
        self.n.translate(1, 1, 1)
        self.assertEqual(self.k.data, self.n.data)
	
        self.k.rotate(0, 1, 1, 1)   
        self.n.rotate(0, 1, 1, 1)
        self.assertEqual(self.k.data, self.n.data)
	
        self.k.rotate_2d(1, 1)   
        self.n.rotate_2d(1, 1)
        self.assertEqual(self.k.data, self.n.data)

        self.k.frustum(1, 2, 1, 2, 1, 2)   
        self.n.frustum(1, 2, 1, 2, 1, 2)
        self.assertEqual(self.k.data, self.n.data)

        self.k.perspective(90, 1, 2, 3)   
        self.n.perspective(90, 1, 2, 3)
        self.assertEqual(self.k.data, self.n.data)
	
        self.k.orthographic(1, 2, 1, 2, 1, 2)   
        self.n.orthographic(1, 2, 1, 2, 1, 2)
        self.assertEqual(self.k.data, self.n.data)
