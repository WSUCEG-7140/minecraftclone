import unittest
# Determines if the skeleton is transparent or not
transparent = True
# Flag indicating if the model represents a cube or not
is_cube = False
# Flag indicating if the skeleton model uses a glass texture or not
glass = False

# An empty list to store colliders for the skeleton model
colliders = []
# The following lists store data for the vertices, texture coordinates, and shading values
# of the skeleton's different body parts.
# Data for the 'body' bone
